...
class StockTradingEnv(gym.Env):
    ...
    def _next_observation(self):
        obs = np.array([
            ...
            self.df.loc[self.current_step, 'avgprice'] / MAX_SHARE_PRICE,
    ...
    def _take_action(self, action):
        ...
        current_price = self.df.loc[self.current_step, "avgprice"]
    ...
    def step(self, action):
        ...
        daily_pnl = self.net_worth - INITIAL_ACCOUNT_BALANCE
        ...
        return obs, reward, ternimated, truncated, {'daily_pnl':daily_pnl}

    def reset(self, seed=None, new_df=None):
    ...
    def render(self, mode='human', close=False) -> int:
